        ...
        <Box className={classes.box}>
            <div className={classes.box_content}>
                   ...
                   <h1 className={classes.subtitle}> Learning about life. Sharing the discoveries.</h1>
                    <p className={classes.p}> I release a weekly newsletter on a variety of topics including philosophy, psychology, creativity, and self-development.</p>
                    <p className={classes.p}>Subscribe and get mind-expanding insights sent directly to your inbox every Sunday.</p>  
